...
const PRODUCTS = [
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Modern Black LED Floor Lamp 185cm | Warm Light Standing Lamp for Living Room, Bedroom & Office | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Modern Floor Lamp with Linen Shade | 158cm Black Standing Lamp with 2700K Bulb & Foot Switch | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Dimmable Linen Floor Lamp with Remote Control | 3 Color Temperatures & 9W LED Bulb | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Modern Black Floor Lamp with Lampshade | 3 Color Temperatures & 12W LED Bulb | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Modern Black Arc Floor Lamp with Adjustable Shade | Standing Reading Lamp with Foot Switch | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Dimmable LED Corner Floor Lamp | 3 Color Temperatures & 180° Wide-Area Lighting | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Smart RGB Corner Floor Lamp | 16 Million Colors with App, Remote & Music Sync | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Dimmable LED Reading Floor Lamp with Gooseneck | 3 Colors, 10 Brightness Levels & 120 LEDs | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Modern LED Floor Lamp with Warm Light | Slim Vertical Standing Lamp for Living Room & Bedroom | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    seoTitle: 'Battery Operated Wall Sconces 2 Pack with Remote | Dimmable Linen Wall Lamps | lamporia.ae',
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    name: 'Battery Operated Wall Sconces 2 Pack with Remote',
    seoTitle: 'Battery Operated Wall Sconces 2 Pack with Remote | Dimmable Linen Wall Lamps for Bedroom & Living Room | lamporia.ae',
